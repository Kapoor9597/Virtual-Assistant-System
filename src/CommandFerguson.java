              ...
              //gmail
               ...
               //eject drive
                ...
                //open paint
                 ...
                 TextToSpeech generator = new TextToSpeech("My name is DeadShot");
                 voiceTxtCapture.setText(voiceToText);
                 }
                 ...
                 TextToSpeech generator = new TextToSpeech("How can I help you ? ");
                 voiceTxtCapture.setText(voiceToText);
                 }
                 ...
                 TextToSpeech generator = new TextToSpeech("Shaksham Kapoor");
                 voiceTxtCapture.setText(voiceToText);
                 }*/
                 ...
                 */
                 ...
                 //check ip
                 else if(voiceToText.equalsIgnoreCase("check ip")){
                 try {
                 ...
                 */
                 ...
                 //wow
                    ...
                    voiceTxtCapture.setText(voiceToText);
                    TextToSpeech generator = new TextToSpeech("Thank you !! I'm privilaged to help you");
                   }
                 
                   //instruction
                   else if(voiceToText.equalsIgnoreCase("instruction")){
                    voiceTxtCapture.setText(voiceToText);
                    TextToSpeech generator = new TextToSpeech("See my instruction list");
                   ...
                   //how are you
                    ...
                    voiceTxtCapture.setText(voiceToText);
                    TextToSpeech generator = new TextToSpeech("I am fine, Thank you!! What about you ?");
                    instructionList open = new instructionList();
                    open.setVisible(true);
                   }
                  ...
                  TextToSpeech generator = new TextToSpeech("Trying to detect");
                }
           }
       }
     }
